This is a python script generated by ChatGPT 3.5. The purpuse is to upload native icon to the github reps and to build a visualization website，where you can copy and paste the code on anywhere.
<h2>
  Getting  startted  
</h2>
